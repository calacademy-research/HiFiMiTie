...
[ -z $wdir ] && wdir="."  #msglog_module "The hfmt_<num> working directory not found" && exit 2

mito_fasta=$1
[ -z $mito_fasta ] && msg "    usage: rrna_cmsearch.sh <mito fasta file>" && exit 1
...
function check_files {
    ...
    cm_12S="${src_dir}/models/12S_s-rna.cm"
    cm_16S="${src_dir}/models/16S_l-rna.cm"
